...
export default function HorizontalScrollSection() {
  ...
  return (
    ...
    >
      ...
      <div
        className="xl:sticky xl:top-0 xl:h-screen h-full overflow-hidden "
          ...
          >
            ...
            >
              <div className="relative p-6 sm:p-12 md:p-16 xl:p-0 xl:px-16 xl:pt-2 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-xl shadow-3xl">
                <div className="absolute inset-0 rounded-2xl border borderBox pointer-events-none" />
                <div className="flex flex-col xl:grid xl:grid-cols-2 gap-10 xl:gap-16 items-center">
                  ...
                  >
                    <Image
                      ...
                      width={300}
                      height={300}
                      className="xl:rounded-t-xl rounded-xl  xl:rounded-none  object-cover w-full "
                    />
                  </motion.div>
                </div>
              </div>
                  ...
                  {isDesktop ? (
                    ...
                    >
                      {[
                        ...
                        <motion.div
                          key={i}
                          className="absolute rounded-xl overflow-hidden shadow-xl border borderBox bg-black/10 backdrop-blur-sm"
                          style={{
                            width: "80%",
                            height: "80vh",
                          }}
